...
@section('content')
    ...
    <main style="background-color: #252121;">
        <div class="container-fluid px-4">
            <div class="card mt-4" style="background-color:#252121;">
                ...
                <div class="card-body">
                    ...
                    <section>
                        <div class="container py-5">
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="card mb-4" style="background-color: rgb(47, 35, 35)">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="card mb-4" style="background-color:  rgb(47, 35, 35)s">
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-sm-3">
